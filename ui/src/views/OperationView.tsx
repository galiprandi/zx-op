  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {useScanner ? 'Escáner' : 'Ingreso Manual'}
          </CardTitle>
          <CardDescription>
            {useScanner 
      ...
      {wristbandCode && (
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="text-center">
              <div className={`text-6xl font-bold font-mono ${getTimeColor(mockSession.remainingMinutes)}`}>
                {String(mockSession.remainingMinutes).padStart(2, '0')}:
                {String(mockSession.remainingSeconds).padStart(2, '0')}
              </div>
              <div className="text-sm text-muted-foreground mt-2">
                Estado: <span className="font-medium">{mockSession.status}</span>
              </div>
            </div>
