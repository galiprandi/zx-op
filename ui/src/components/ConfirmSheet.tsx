...
export function ConfirmSheet({ 
  ...
  return (
    <div className={cn(modalOverlayClass, "px-4 min-h-screen")} style={{top: '0', left: '0', right: '0', bottom: '0', height: '100vh', minHeight: '100vh'}}>
      <GlassCard className={cn(modalPanelBaseClass, "max-w-sm")}>
